...
def query_enhancer(context,query,path):
      ...
      output = llm(
            f"Q: The context is {context} .Query: {query} . Now answer the query using the context provided. Provide a precise and consise answer. Answer in less than 60 words. A:", # Prompt
